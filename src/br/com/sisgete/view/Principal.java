...
jtfDataNascimento.addCommitListener(new datechooser.events.CommitListener() {
    ...
    private void obterDadosDoencas() {
        ...
        medicamentoTratamento1Model.setAlcoolPeriodo(jtfPeriodoAlcool.getText());
        medicamentoTratamento1Model.setAlcoolTipo(tipoAlcool);
        medicamentoTratamento1Model.setDengue(jcbDengue.getSelectedItem().toString());
        medicamentoTratamento1Model.setDengueObs(obsDengue);
        medicamentoTratamento1Model.setDenguePeriodo(jtfPeriodoDengue.getText());
        medicamentoTratamento1Model.setDengueTipo(tipoDengue);
        medicamentoTratamento1Model.setDiabetes(jcbDiabetes.getSelectedItem().toString());
        medicamentoTratamento1Model.setDiabetesObs(obsDengue);
        medicamentoTratamento1Model.setDiabetesPeriodo(jtfPeriodoDiabetes.getText());
        medicamentoTratamento1Model.setDiabetesTipo(tipoDiabetes);
        medicamentoTratamento1Model.setFumo(jcbFumo.getSelectedItem().toString());
        medicamentoTratamento1Model.setFumoObs(obsFumo);
        medicamentoTratamento1Model.setFumoPeriodo(jtfPeriodoFumo.getText());
        medicamentoTratamento1Model.setFumoTipo(tipoFumo);
        medicamentoTratamento1Model.setHepatite(jcbHepatite.getSelectedItem().toString());
        medicamentoTratamento1Model.setHepatiteObs(obsHepatite);
        medicamentoTratamento1Model.setHepatitePeriodo(jtfPeriodoHepatite.getText());
        medicamentoTratamento1Model.setHipertensao(jcbHipertensao.getSelectedItem().toString());
        medicamentoTratamento1Model.setHipertensaoObs(obsHipertensao);
        medicamentoTratamento1Model.setHipertensaoPeriodo(jtfPeriodoHipertensao.getText());
        medicamentoTratamento1Model.setHipertensaoTipo(tipoHipertensao);
        medicamentoTratamento1Model.setRemedio(jcbRemedioControlado.getSelectedItem().toString());
        medicamentoTratamento1Model.setRemedioObs(obsRemedios);
        medicamentoTratamento1Model.setRemedioPeriodo(jtfPeriodoRemedio.getText());
        medicamentoTratamento1Model.setRemedioTipo(tipoRemedios);
        medicamentoTratamento1Model.setUsoParacetamol(jcbParacetamol.getSelectedItem().toString());
        medicamentoTratamento1Model.setUsoParacetamolObs(obsParacetamol);
        medicamentoTratamento1Model.setUsoParacetamolPeriodo(jtfPeriodoParacetamol.getText());
        medicamentoTratamento1Model.setUsoParacetamolTipo(tipoParacetamol);

        medicamentoTratamento2Model.setAlergias(jcbAlergia.getSelectedItem().toString());
        medicamentoTratamento2Model.setAlergiasObs(obsAlergias);
        medicamentoTratamento2Model.setAlergiasPeriodo(jtfPeriodoAlergia.getText());
        medicamentoTratamento2Model.setAlergiasTipo(tipoAlergias);
        medicamentoTratamento2Model.setCancer(jcbCancer.getSelectedItem().toString());
        medicamentoTratamento2Model.setCancerObs(obsCancer);
        medicamentoTratamento2Model.setCancerPeriodo(jtfPeriodoCancer.getText());
        medicamentoTratamento2Model.setCancerTipo(tipoCancer);
        medicamentoTratamento2Model.setDoencaEstomago(jcbDoencaEstomago.getSelectedItem().toString());
        medicamentoTratamento2Model.setDoencaEstomagoObs(obsDoencaEstomago);
        medicamentoTratamento2Model.setDoencaEstomagoPeriodo(jtfPeriodoDoencaEstomago.getText());
        medicamentoTratamento2Model.setDoencaEstomagoTipo(tipoDoencaEstomago);
        medicamentoTratamento2Model.setDoencaOssos(jcbDoencaOssos.getSelectedItem().toString());
        medicamentoTratamento2Model.setDoencaOssosObs(obsDoencaOssos);
        medicamentoTratamento2Model.setDoencaOssosPeriodo(jtfPeriodoDoencaOssos.getText());
        medicamentoTratamento2Model.setDoencaOssosTipo(tipoDoencaOssos);
        medicamentoTratamento2Model.setDoencaPulmoes(jcbDoencaPulmoes.getSelectedItem().toString());
        medicamentoTratamento2Model.setDoencaPulmoesObs(obsDoencaPulmoes);
        medicamentoTratamento2Model.setDoencaPulmoesPeriodo(jtfPeriodoDoencaPulmoes.getText());
        medicamentoTratamento2Model.setDoencaPulmoesTipo(tipoDoencaPulmoes);
        medicamentoTratamento2Model.setFeridasTumores(jcbFeridas.getSelectedItem().toString());
        medicamentoTratamento2Model.setFeridasTumoresObs(obsFeridas);
        medicamentoTratamento2Model.setFeridasTumoresPeriodo(jtfPeriodoFeridas.getText());
        medicamentoTratamento2Model.setFeridasTumoresTipo(tipoFeridas);
        medicamentoTratamento2Model.setHernia(jcbHernia.getSelectedItem().toString());
