...
public class MagnetizadorView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("E AUXILIARES REGULARES NO ATENDIMENTO ESPIRITUAL MAGNÉTICO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MagnetizadorView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
