...
public class PacienteDAO extends SisgeteConnectionMySql {
    ...
    public ArrayList<PacienteModel> getListaPacienteDAO() {
        ...
        try {
            ...
            new LogCatch().writeLog("Erro ao buscar dados: " + e, getClass().toString());
        } finally {
            this.fecharConexao();
        }
    ...
    public ArrayList<PacienteModel> getListaPacienteLiberadoDAO() {
        ...
        try {
            this.conectar();
            this.executarSQL(
                    "SELECT * FROM tbl_paciente WHERE status_tratamento='LIBERADO';"
            );
    ...
    /**
     * recupera um arrayList com os pacientes com fichas inativas
     *
     * @return
     */
    public ArrayList<PacienteModel> getListaPacienteInativoDAO() {
        ...
        try {
            this.conectar();
            this.executarSQL(
                    "SELECT * FROM tbl_paciente WHERE tbl_paciente.status_ficha='INATIVA';"
            );
