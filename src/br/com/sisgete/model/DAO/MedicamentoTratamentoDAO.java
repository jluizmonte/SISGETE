    ...
    public boolean atualizarMedicamentoTratamentoDAO(MedicamentoTratamentoModel modelMedicamentoTratamento) {
        try {
            ...
            return this.executarUpdateDeleteSQL(
                    ...
                    + "remedio = '" + modelMedicamentoTratamento.getRemedio() + "',"
                    + "remedio_tipo = '" + modelMedicamentoTratamento.getRemedioTipo() + "',"
                    + "remedio_periodo = '" + modelMedicamentoTratamento.getRemedioPeriodo() + "',"
                    + "remedio_obs = '" + modelMedicamentoTratamento.getRemedioObs() + "',"
                    ...
                    + "doenta_autoimune = '" + modelMedicamentoTratamento.getDoencaAutoimune() + "',"
                    + "doenta_autoimune_tipo = '" + modelMedicamentoTratamento.getDoencaAutoimuneTipo() + "',"
                    + "doenta_autoimune_periodo = '" + modelMedicamentoTratamento.getDoencaAutoimunePeriodo() + "',"
                    + "doenta_autoimune_obs = '" + modelMedicamentoTratamento.getDoencaAutoimuneObs() + "',"
